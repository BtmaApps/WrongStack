...
export const clarifyTool: Tool<ClarifyQuestionInput, ClarifyOutput> = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      isMultiSelect: { type: 'boolean', description: 'Legacy alias for type: multi_select.' },
      is_multi_select: {
        type: 'boolean',
      ...
      placeholder: { type: 'string', description: 'Placeholder text for a text response.' },
      questions: {
        type: 'array',
        minItems: 1,
      ...
      tabs: {
        ...
        items: {
          type: 'object',
          properties: {
            id: { type: 'string', description: 'Stable tab identifier.' },
  ...
  return {
    ...
    properties: {
      ...
      type: {
        type: 'string',
        enum: ['single_select', 'multi_select', 'text'],
        description: 'Input mode for this question.',
      },
      options: {
        ...optionArraySchema(),
        description: 'Selectable string labels or labelled option objects for this question.',
      },
      recommendedOption: {
        type: 'string',
        description: 'Recommended option id or label for one-choice questions.',
      ...
      required: { type: 'boolean', description: 'Whether the user must answer before submitting.' },
      placeholder: { type: 'string', description: 'Placeholder text for a text response.' },
    },
    required: ['question'],
    additionalProperties: false,
