...
// separators as the \u0000 escape sequence instead (sweeps r1-sage-recovery-bin
// and r2-nul-source-sweep, 2026-09-15).
const FILES = [
  '../src/sqlite-store-recovery.ts',
  '../src/middleware/domain-term-extractor-middleware.ts',
];
