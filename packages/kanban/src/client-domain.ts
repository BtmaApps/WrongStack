...
export const listBoardHistory = bindDomainOperation('listBoardHistory');
...
export const removeCheckFromTask = bindDomainOperation('removeCheckFromTask');
...
export const getKanbanWorkbench = bindDomainOperation('getKanbanWorkbench');
...
export const getContractGraph = bindDomainOperation('getContractGraph');
export const configureContractGraph = bindDomainOperation('configureContractGraph');
export const upsertContractNode = bindDomainOperation('upsertContractNode');
export const addContractEdge = bindDomainOperation('addContractEdge');
export const removeContractNode = bindDomainOperation('removeContractNode');
export const removeContractEdge = bindDomainOperation('removeContractEdge');
export const evaluateTaskContractGraph = bindDomainOperation('evaluateTaskContractGraph');
