...
export const ROLE_SKILL_SETS = {
  explore: skillSet('codebase-navigation', 'research-web', 'node-modern', 'typescript-strict'),
  ...
  tracer: skillSet('observability', 'audit-log', 'debugging', 'bug-hunter', 'testing'),
  ...
  test: skillSet('testing', 'typescript-strict', 'bug-hunter', 'security-scanner', 'debugging'),
  ...
  reviewer: skillSet('chimera', 'bug-hunter', 'security-scanner', 'testing', 'code-review'),
  'code-reviewer': skillSet('code-review', 'bug-hunter', 'typescript-strict', 'testing', 'chimera'),
