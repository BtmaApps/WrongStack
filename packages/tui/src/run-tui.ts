  ...
  return new Promise<number>((resolve) => {
    ...
    try {
      ...
      const appElement = React.createElement(App, {
        ...
        queueStoreFor: opts.queueStoreFor,
        ...
        statuslineLines: opts.statuslineLines,
        setStatuslineLines: opts.setStatuslineLines,
        saveStatuslineLines: opts.saveStatuslineLines,
        statuslineDensities: opts.statuslineDensities,
        setStatuslineDensities: opts.setStatuslineDensities,
        saveStatuslineDensities: opts.saveStatuslineDensities,
        statuslineOrder: opts.statuslineOrder,
        setStatuslineOrder: opts.setStatuslineOrder,
        saveStatuslineOrder: opts.saveStatuslineOrder,
