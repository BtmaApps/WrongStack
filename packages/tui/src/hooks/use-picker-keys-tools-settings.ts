...
import { tryBrainStatuslinePickerKeys } from './use-picker-keys-brain-statusline.js';
...
export function tryToolsSettingsPickerKeys(
  ...
  if (tryBrainStatuslinePickerKeys(host, input, key, isEnter, debouncedEnter)) return true;
