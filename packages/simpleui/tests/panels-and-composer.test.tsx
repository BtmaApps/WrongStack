  ...
  it('routes composer permissions, file choices, attachments, and send modes', () => {
    ...
    const props = {
      composer: {
        ...
        ...actions,
        // Hook names for the two actions the assertions still address by
        // their legacy on* keys.
        attachImages: actions.onAttachImages,
        removeImage: actions.onRemoveImage,
      } as never,
      running: true,
      connection: 'open',
