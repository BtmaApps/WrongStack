...
**Generated:** 2026-09-25T10:26:39.727Z
...
| Production source files | 4208 |
| Production source lines | 992041 |
| Test files | 3738 |
| Workspace dependency edges | 130 |
| Relative module edges | 13732 |
...
| @wrongstack/core | 961 | 843 | @wrongstack/kanban, @wrongstack/persistence, @wrongstack/primitives |
...
| @wrongstack/tools | 237 | 280 | @wrongstack/core, @wrongstack/kanban, @wrongstack/persistence, @wrongstack/primitives |
...
| @wrongstack/webui | 596 | 415 | @wrongstack/core, @wrongstack/kanban, @wrongstack/plugins, @wrongstack/providers, @wrongstack/tools, @wrongstack/webui-protocol |
...
| @wrongstack/webui-server | 253 | 238 | @wrongstack/core, @wrongstack/kanban, @wrongstack/mcp, @wrongstack/primitives, @wrongstack/providers, @wrongstack/requirement-intake, @wrongstack/runtime, @wrongstack/sage, @wrongstack/sdd, @wrongstack/techstack, @wrongstack/tools, @wrongstack/vector-memory, @wrongstack/webui-protocol, @wrongstack/wrongtrace |
...
| 999 | `packages/cli/src/execution.ts` |
| 999 | `packages/tools/src/_danger-detect.ts` |
| 981 | `packages/sage/src/sqlite-store.ts` |
| 969 | `packages/core/src/coordination/director.ts` |
...
| 899 | `packages/cli/src/cli-main.ts` |
...
| 890 | `packages/webui-server/src/server/backend-services.ts` |
...
| 885 | `packages/providers/src/index.ts` |
